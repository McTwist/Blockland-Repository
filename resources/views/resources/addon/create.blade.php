		...
		<fieldset class="blr-fieldset">
			...
			<div class="row">
				...
				<div class="row form-group">
					...
					<div class="col-xs-12 col-sm-8">
						{{ Form::text('authors', $authors, ['required' => 'true', 'class' => 'form-control blr-form-control authors']) }}
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-xs-12 col-sm-8">
						{{ Form::textarea('description', $description, ['class' => 'form-control blr-form-control']) }}
					</div>
				</div>
