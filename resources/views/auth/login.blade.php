	...
	<fieldset class="blr-fieldset">
		...
		<div class="container-fluid">
			...
			<div class="row extend-md-double">
				<div class="col-xs-12 nopad-xs-both col-sm-6 col-sm-push-6 col-md-2">
				...
				<div class="col-xs-12 nopad-xs-both col-sm-6 col-sm-pull-6 col-md-3 col-md-pull-0 col-md-push-1">
					{{-- Forgot password --}}
